...
function Permanentdeletee(index){
    ...
    return (
        <div className='container'>
         ...
         <div className='row'>
            <div className='col-6'>
         <Display title="Left Side Tasks" delete={Permanentdeletee} data={leftData} handler={RemoveHandler}/>
         </div>

         <div className='col-6'>
         <Display title="Right Side Tasks" delete={Permanentdelete} data={rightData} handler={RemoveHandlerr}/>
         </div>
         </div>
        </div>
    );
